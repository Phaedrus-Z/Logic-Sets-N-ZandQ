	...
	\chapter{Set Theory}
		...
		\section{Functions}
			...
			\begin{verify}[Composition is well-defined]
				Let $X$, $Y$ and $Z$ be sets, and let $f,\tilde{f}:X\to Y$ and $g,\tilde{g}:Y\to Z$ be functions such that $f=\tilde{f}$ and $g=\tilde{g}$. Then $f\circ g=\tilde{f}\circ\tilde{g}$.
			\end{verify}
			\begin{proof}
			...
			\begin{definition}[Inverse function]
				Let $f:X\to Y$ be a bijective function, then $\forall x\in X~\exists!y\in Y~f(x)=y$. This value of $x$ is denoted $f^{-1}(y)$; thus $f^{-1}$ is a function from $Y$ to $X$. We call $f^{-1}$ the inverse of $f$.
			\end{definition}
			...
			\begin{lemma}
				...
				\begin{itemize}
					\item $f$ and $g$ are both injective $\implies$ $f\circ g$ is injective.
					\item $f$ and $g$ are both surjective $\mspace{-9mu}\implies$ $f\circ g$ is surjective.
				\end{itemize}
			\end{lemma}
			\begin{proof}
			...
			\end{proof}
			\begin{lemma}
				The empty function $f:\emptyset\to X$ is:
				\begin{itemize}
					\item injective when...
					\item surjective when...
					\item bijective when...
				\end{itemize}
			\end{lemma}
			\begin{proof}
			...
			\begin{proposition}[Cancellation laws for composition]
				...
				\begin{itemize}
					...
					\item Is the same statement true if $g$ is not injective?
					\item $g\circ f=\tilde{g}\circ f\land f\text{~is~surjective}\implies g=\tilde{g}$.
					\item Is the same statement true if $f$ is not surjective?
				\end{itemize}
			\end{proposition}
			\begin{proof}
			...
			\begin{lemma}
				...
				\begin{itemize}
					...
					\item Is it true that $g$ must also be injective?
					\item $g\circ f\text{~is~surjective}\implies g\text{~is surjective}$
					\item Is it true that $f$ must also be surjective?
				\end{itemize}
			\end{lemma}
			\begin{proof}
			...
			\end{proof}
			\begin{lemma}
				Let $f:X\to Y$ and $g:Y\to Z$ be functions, then if $f$ and $g$ are both bijective then $f\circ g$ is also bijective and $(f\circ g)^{-1}=f^{-1}\circ g^{-1}$.
			\end{lemma}
			\begin{proof}
