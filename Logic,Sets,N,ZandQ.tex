...
\author{Ph\ae drus}
\graphicspath{{F:\Mathematics\Mathematical Analysis\A New Approach to Mathematical Analysis\Graphics}}
\title{\Huge\textit{Logic, Sets, $\mathbb{N}$, $\mathbb{Z}$ and $\mathbb{Q}$}}
	...
	Since set theory is foundation of many other branches of mathematics, we now present some basic information of set theory.
		\section{Fundamentals}
			...
			\begin{axiom}[Replacement]
				Let $A$ be a set. For any object $x\in A$, and any object $y$, suppose we have a statement $P(x,y)$ that
			\end{axiom}
